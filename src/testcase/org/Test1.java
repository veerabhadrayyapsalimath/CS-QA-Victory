...
public class Test1 {
	...
	String y=	driver.findElement(By.xpath("//option[text()='Relevancy']")).getText();
	System.out.println(y);
	if(y.equals("Relevancy"))
	{
		System.out.println("Sort by is present::"+"TEST CASE PASS");
		String x=	driver.findElement(By.xpath("//div[@id='unbxd_dektop_sort_container']")).getText();
		System.out.println("--The data present in SortBy--");
		System.out.println(x);		
	}
	else
	{
		System.out.println("Sort by is not present::"+"TEST CASE FAIL");
	}
